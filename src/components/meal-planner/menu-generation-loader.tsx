      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-md mx-auto">
        ...
        <div className="relative mb-6 sm:mb-8">
          ...
          <div className="relative w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center">
            <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-orange-600 rounded-full animate-spin-slow opacity-80 blur-sm" />
            <div className="relative bg-gradient-to-br from-amber-500 to-orange-600 rounded-full p-4 sm:p-5 shadow-2xl">
              <CalendarDays className="h-10 w-10 sm:h-12 sm:w-12 text-white animate-pulse" />
            </div>
          </div>
