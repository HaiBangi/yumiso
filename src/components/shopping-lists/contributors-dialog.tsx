  ...
  const removeContributor = async (contributorId: number) => {
    try {
      const res = await fetch(
        `/api/shopping-lists/${listId}/contributors/${contributorId}`,
        { method: "DELETE" }
      );
          ...
          <div className="p-6">
            <SheetHeader>
              ...
              <SheetDescription className="text-left">
                Invitez des personnes à collaborer sur cette liste de courses. Les contributeurs peuvent modifier et cocher les articles.
              </SheetDescription>
            </SheetHeader>
            <div className="mt-4">
              {content}
